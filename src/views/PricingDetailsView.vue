        ...
        <div class="container">
            <div class="row">
                <div class="tit">
                    ...
                    <p>Cras nulla nulla, pulvinar sit amet nunc at, lacinia viverra lectus. Fusce imperdiet ullamcorper
                        metus eu fringilla.</p>
                </div>
                <div>
                    <ul>
                        <li>
                            <div class="pri-box">
                                ...
                                <div class="c3">
                                    ...
                                    <a href="/auth/login.php">Add listing</a>
                                </div>
                                <div class="c4">
                                    <ol>
                                        <li>1 Listing </li>
                                        ...
                                        <li>Create duplicate listing</li>
                                ...
                                <div class="c5">
                                    <a href="/auth/login.php">Get Start</a>
                                </div>
                            </div>
                        </li>
                        <li>
...
<span class="btn-ser-need-ani"><img src="/src/assets/images/icon/help.png" alt=""></span>
