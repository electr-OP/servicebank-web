...
<div class="ud-lhs">
    <div class="ud-lhs-s1">
        ...
        <div class="ud-lhs-pro-bio">
            ...
            <RouterLink class="ud-lhs-view-pro" :to="{name: 'settings'}">My Profile</RouterLink>
        </div>
    </div>
    <div class="ud-lhs-s2">
        <ul>
            ...
            <li>  
                <h4>Account</h4>
                <RouterLink :to="{name: 'settings'}" class=""><img src="/src/assets/images/icon/dbl9.png" alt="">Account Profile</RouterLink>
            </li>  
            <!-- <li>
